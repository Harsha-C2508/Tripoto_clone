...
import { getData1,
         ...
         getData7, 
         getData8,
         getData9} from '../Redux/AppRedux/action';
...
import PageIII from './Pages/PageIII';
import {useNavigate} from 'react-router-dom'
import PageIV from './Pages/PageIV';
const style = {
  position: 'absolute',
  top: '50%',
  left: '50%',
...
const VisitDubai = () => {
  ...
  const dispatch = useDispatch();
   const heading = useSelector((store)=>store.AppRedux.heading)
   const data2 = useSelector((store)=>store.AppRedux.data2)
   const data3 = useSelector((store)=>store.AppRedux.data3)
   const data4 = useSelector((store)=>store.AppRedux.data4)
   const data5 = useSelector((store)=>store.AppRedux.data5)
   const data6 = useSelector((store)=>store.AppRedux.data6)
   const data7 = useSelector((store)=>store.AppRedux.data7)
   const data8 = useSelector((store)=>store.AppRedux.data8)
   const data9 = useSelector((store)=>store.AppRedux.data9)
//   console.log(data2)
  useEffect(()=>{
    dispatch(getData1())
  },[dispatch])
     ...
     {/* body get starts here */}
        <div className={Styles.bodyHead}>
            ...
            <div className={Styles.padding30}>
                <img src="https://cdn1.tripoto.com/assets/2.9/img/logo/mini-logo.png" alt="" style={{height:"10px",width:"10px"}} />
                        ...
                        <Swiper slidesPerView={3}
                            ...
                            <div>
                                ...
                                <Modal
                                  ...
                                  >
                                    <Box sx={style}>
                                     <iframe width="100%" height="305px" src="https://www.youtube.com/embed/QmSd8XidTAo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </Box>
                                  </Modal>
                            ...
                            >
                            {
                              data2.map((pro)=>{
                                return <SwiperSlide key={pro.id}>
                                 <div className={Styles.slid2} onClick={gotodet}>
            ...
            {/* Heading part */}
            <div>
              <img src="https://cdn1.tripoto.com/media/filter/nxxl/img/311219/Image/1640869884_explore_web.jpg" alt="" style={{ width:'100%',height:"70px"}}  className={Styles.marginTop2}/>
